...
public class JwtTokenProvider {
	...
	//암복호화에 사용되는 키 값 입니다.
	private static String secretKey = Base64.getEncoder().encodeToString("bitwin".getBytes());
...
//	    claims.put("roles", new Object() );  //객체도 가능합니다 ^^
	    ...
	    return Jwts.builder()
	            ...
	            .setExpiration(new Date(System.currentTimeMillis()+ 60 * 10000 * 6 * 3)) // 만료 기간 입니다(60*10000 = 10분 )
